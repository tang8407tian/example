package com.ttac.service.mybatis.config.swagger;
 ...
 * swagger 登录
 * http://localhost:9001/service-mybatis/swagger-ui.html
*/
...
public class Swagger2Configuration {
    ...
    public Docket userApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apiInfo(userApiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.ttac.service.mybatis.controller.user"))
                .build();
    ...
    @Bean
    public Docket txtApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .groupName("txt")
                .apiInfo(userApiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.ttac.service.mybatis.controller.txt"))
                .build();

    }
    private ApiInfo txtApiInfo() {
